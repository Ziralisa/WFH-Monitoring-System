                                    ...
                                    <tbody>
                                        @foreach ($staff as $member)
                                            <tr class="{{ $member->hasRole('resign') ? 'resigned' : '' }}">
                                                <td class="text-xs text-center font-weight-bold mb-0">{{ $member->name }}
                                                </td>
                                                <td class="text-xs text-center font-weight-bold mb-0">{{ $member->email }}
                                                </td>
                                                <td class="text-xs text-center font-weight-bold mb-0">
                                                    {{ implode(', ', $member->getRoleNames()->toArray()) }}</td>
                                                <td class="text-xs text-center font-weight-bold mb-0">
                                                    @if ($member->hasRole('staff'))
                                                        <button type="button" class="btn btn-danger btn-sm" data-toggle="modal"
                                                            data-target="#confirmModal"
                                                            onclick="setFormAction('{{ route('admin.staff.remove-role', $member->id) }}')">
                                                            Remove Role
                                                        </button>
                                                    @endif
                                                    ...
                                                    <button type="button" class="btn btn-warning edit-button btn-sm"
                                                        ...
                                                        data-location="{{ $member->location }}" data-toggle="modal"
                                                    ...
                                                    @if (!$member->hasRole('staff'))
                                                        <form action="{{ route('admin.staff.delete', $member->id) }}"
