    ...
    <ul class="navbar-nav">
                    ...
                    <div
                        ...
                        <i style="font-size: 1rem;"
                            class="fas fa-xs fa-chart-line ps-2 pe-2 text-center
                                {{ in_array(request()->route()->getName(), ['history']) ? 'text-white' : 'text-dark' }}"></i>
                    </div>
                    <span class="nav-link-text ms-1">Attendance History</span>
                </a>
            </li>
        @endif
        ...
        <li class="nav-item pb-2">
            <a class="nav-link {{ Route::currentRouteName() == 'dashboard' ? 'active' : '' }}"
                ...
                <span class="nav-link-text ms-1">Dashboard (DEMO)</span>
            </a>
        </li>
        <!-- Dashboard Example Button ends here..-->
        <li class="nav-item">
            <a class="nav-link {{ Route::currentRouteName() == 'laravel-user-profile' ? 'active' : '' }}"
